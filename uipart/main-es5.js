...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardDialogComponent = /** @class */ (function () {
                function DashboardDialogComponent(dialog, dat) {
                    this.dialog = dialog;
                    this.dat = dat;
                ...
                DashboardDialogComponent.prototype.test = function () {
                    this.dialog.closeAll();
                };
                return DashboardDialogComponent;
            }());
            DashboardDialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function () {
                function DashboardComponent(Api, dialog) {
                    this.Api = Api;
                    this.dialog = dialog;
                ...
                DashboardComponent.prototype.openDialog = function (data) {
                    // console.log(data)
                    // const dialogRef = this.dialog.open(DashboardDialogComponent);
                    var dialogRef = this.dialog.open(_dashboard_dialog_dashboard_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DashboardDialogComponent"], {
                        data: data,
                    });
                ...
                DashboardComponent.prototype.openDialog1 = function () {
                    var dialogRef = this.dialog.open(_dashboard_dialog_dashboard_dialog_component__WEBPACK_IMPORTED_MODULE_4__["DashboardDialogComponent"]);
                };
                DashboardComponent.prototype.alldetails = function () {
                    ...
                    this.Api.getallDetail().then(function (res) {
                        ...
                        // this.options = res;      
                        res.forEach(function (i) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
